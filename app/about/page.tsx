...
export const metadata: Metadata = {
  title: 'About us',
  description: 'The story behind OnTheCanals.Amsterdam — the platform for all water activities on the Amsterdam canals.',
}
    ...
    <div className="min-h-screen bg-[#faf7f2] pt-16">
      ...
      <div className="max-w-3xl mx-auto px-5 py-12 space-y-12">
        ...
        <section className="bg-canal-dark rounded-2xl p-8 text-white">
          ...
          <p className="text-white/65 mb-6">Join OnTheCanals.Amsterdam and reach thousands of tourists per month. Free to sign up, commission-based model — you only pay when you receive a booking through our platform.</p>
          ...
          <Link href="/contact#provider" className="inline-flex items-center gap-2 bg-amber hover:bg-amber-dark text-white font-bold px-6 py-3 rounded-xl text-sm transition-colors">
